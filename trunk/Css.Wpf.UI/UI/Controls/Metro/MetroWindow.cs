...
using Css.Wpf.UI.Controls.Dialogs;
...
namespace Css.Wpf.UI.Controls
{
    ...
    public class MetroWindow : Window
    {
        ...
        public static readonly DependencyProperty TitleCharacterCasingProperty = DependencyProperty.Register("TitleCharacterCasing", typeof(CharacterCasing), typeof(MetroWindow), new FrameworkPropertyMetadata(CharacterCasing.Normal, FrameworkPropertyMetadataOptions.Inherits | FrameworkPropertyMetadataOptions.AffectsMeasure), value => CharacterCasing.Normal <= (CharacterCasing)value && (CharacterCasing)value <= CharacterCasing.Upper);
        ...
        /// <summary>
        /// Initializes a new instance of the Css.Wpf.UI.Controls.MetroWindow class.
        /// </summary>
        public MetroWindow()
        {
