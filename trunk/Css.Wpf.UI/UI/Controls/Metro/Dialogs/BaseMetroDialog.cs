...
namespace Css.Wpf.UI.Controls.Dialogs
{
    /// <summary>
    ...
    public abstract class BaseMetroDialog : ContentControl
    {
        ...
        /// <summary>
        /// Initializes a new Css.Wpf.UI.Controls.BaseMetroDialog.
        /// </summary>
        ...
        private void Initialize([CanBeNull] MetroWindow owningWindow, [CanBeNull] MetroDialogSettings settings)
        {
            ...
            {
                this.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Css.Wpf.UI;component/Styles/Controls.xaml") });
            }

            this.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Css.Wpf.UI;component/Styles/Fonts.xaml") });
            this.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Css.Wpf.UI;component/Styles/Colors.xaml") });
            this.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Css.Wpf.UI;component/Themes/Dialogs/BaseMetroDialog.xaml") });
