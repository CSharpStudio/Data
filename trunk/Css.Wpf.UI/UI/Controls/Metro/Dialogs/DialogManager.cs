...
namespace Css.Wpf.UI.Controls.Dialogs
{
    ...
    public static class DialogManager
    {
        ...
        private static Window SetupExternalDialogWindow(BaseMetroDialog dialog)
        {
            ...
            try
            {
                win.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Css.Wpf.UI;component/Styles/Controls.xaml") });
                win.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Css.Wpf.UI;component/Styles/Fonts.xaml") });
                win.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Css.Wpf.UI;component/Styles/Colors.xaml") });
