...
namespace Css.Wpf.UI.Controls.Dashboards
{
    ...
    using Css.Wpf.UI.Controls.Animation;
    using System.ComponentModel;

    public interface IDragDockPanel
    {
    ...
    /// </summary>
    public class DragDockPanel : DraggablePanel, IDragDockPanel
    {
        /// <summary>
        ...
        public static readonly DependencyProperty IsClosableProperty =
            DependencyProperty.Register("IsClosable", typeof(bool), typeof(DragDockPanel),
        ...
        public override void OnApplyTemplate()
        {
            ...
            Button btnClose = this.GetTemplateChild(DragDockPanel.ElementCloseButton) as Button;
        ...
        void btnClose_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                var eventArg = new CancelEventArgs();
                Closing(this, eventArg);
