...
namespace Css.Wpf.UI.Controls.AvalonDock.Controls
{
    ...
    {
        static DocumentPaneTabPanel()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(DocumentPaneTabPanel), new FrameworkPropertyMetadata(typeof(DocumentPaneTabPanel)));
        }
