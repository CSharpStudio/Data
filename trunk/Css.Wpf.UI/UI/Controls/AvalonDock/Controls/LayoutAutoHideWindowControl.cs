...
using Css.Wpf.UI.Controls.AvalonDock.Layout;
...
namespace Css.Wpf.UI.Controls.AvalonDock.Controls
{
    public class LayoutAutoHideWindowControl : HwndHost, ILayoutControl
    {
        ...
        public static readonly DependencyProperty BorderBrushProperty =
            DependencyProperty.Register("BorderBrush", typeof(Brush), typeof(LayoutAutoHideWindowControl), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty BorderThicknessProperty =
            DependencyProperty.Register("BorderThickness", typeof(Thickness), typeof(LayoutAutoHideWindowControl), new PropertyMetadata(new Thickness(0)));
        ...
        void CreateInternalGrid()
        {
            ...
            _internalGrid.Children.Add(border);
