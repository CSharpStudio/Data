...
using Css.Wpf.UI.Converters;
using System.Diagnostics;
using System.Windows.Controls.Primitives;
using Css.Wpf.UI.Commands;
...
namespace Css.Wpf.UI.Controls.AvalonDock.Controls
{
    public class LayoutAnchorableFloatingWindowControl : LayoutFloatingWindowControl, IOverlayWindowHost
    {
        ...
        {
            _model = model;
            CloseWindowCommand = new RelayCommand((p) => OnExecuteCloseWindowCommand(p), (p) => CanExecuteCloseCommand(p));
        }

        internal override void UpdateThemeResources( Css.Wpf.UI.Controls.AvalonDock.Theme oldTheme = null )
        {
