    ...
    public static class ThemeManager
    {
        ...
        public static IEnumerable<Accent> Accents
        {
            get
            {
                ...
                try
                {
                    ...
                    {
                        var resourceAddress = new Uri(string.Format("pack://application:,,,/Css.Wpf.UI;component/Styles/Accents/{0}.xaml", color));
                        _accents.Add(new Accent(color, resourceAddress));
                    }
                }
                catch (Exception e)
                {
                    throw new WpfUiException("This exception happens because you are maybe running that code out of the scope of a WPF application. Most likely because you are testing your configuration inside a unit test.", e);
                }
        ...
        public static IEnumerable<AppTheme> AppThemes
        {
            get
            {
                ...
                var themes = new[] { "BaseLight", "BaseDark", "AquaLight", "AquaDark" };
